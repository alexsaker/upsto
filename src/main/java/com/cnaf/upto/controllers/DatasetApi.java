...
public interface DatasetApi {
    ...
    ResponseEntity<String> listSearchableFields(@ApiParam(value = "Name of the dataset.",required=true) @PathVariable("dataset") String dataset,@ApiParam(value = "Version of the dataset.",required=true) @PathVariable("version") String version);
